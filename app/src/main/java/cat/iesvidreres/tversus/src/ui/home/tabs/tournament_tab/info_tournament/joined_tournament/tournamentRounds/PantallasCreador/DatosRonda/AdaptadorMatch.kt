package com.app.projecte.tversus
...
class AdaptadorMatch(var listaObjetos: List<Match>) : RecyclerView.Adapter<ViewHolder>() {
...
class ViewHolder(val itemView: View, clickListener: AdaptadorMatch.onItemClickListener) : RecyclerView.ViewHolder(itemView) {
