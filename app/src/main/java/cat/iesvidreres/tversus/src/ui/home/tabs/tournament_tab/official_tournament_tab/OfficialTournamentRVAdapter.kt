...
class OfficialTournamentRVAdapter @Inject constructor() : RecyclerView.Adapter<OfficialTournamentRVAdapter.ItemOfficialTournamentHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemOfficialTournamentHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_tournament_view, parent, false)

        return ItemOfficialTournamentHolder(v)
    }

    override fun onBindViewHolder(holder: ItemOfficialTournamentHolder, position: Int) {
    ...
    inner class ItemOfficialTournamentHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
